        ...
        <div class="row">
            <div class="col-sm-12 col-md-3 text-center">
                <div class="card mb-4 box-shadow">
                    <a href="expense/list"><i class="fas fa-money-bill-alt fa-10x"></i></a>
                    <div class="card-body">
                        <a href="/expense/list"><h2>Wydatki</h2></a>
                        <a href="/expense/list" ><p>Lista wydatków</p></a>
                        <a href="/expense/add"><p>Dodaj wydatek</p></a>
                        <a href="/category/list"><p>Kategorie wydatków</p></a>
